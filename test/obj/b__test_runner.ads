...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#a9ca309f#;
   ...
   u00055 : constant Version_32 := 16#a201b8c5#;
   pragma Export (C, u00055, "ada__strings__text_buffersB");
   u00056 : constant Version_32 := 16#a7cfd09b#;
   pragma Export (C, u00056, "ada__strings__text_buffersS");
   u00057 : constant Version_32 := 16#e6d4fa36#;
   pragma Export (C, u00057, "ada__stringsS");
   u00058 : constant Version_32 := 16#8b7604c4#;
   pragma Export (C, u00058, "ada__strings__utf_encodingB");
   u00059 : constant Version_32 := 16#c9e86997#;
   pragma Export (C, u00059, "ada__strings__utf_encodingS");
   u00060 : constant Version_32 := 16#bb780f45#;
   pragma Export (C, u00060, "ada__strings__utf_encoding__stringsB");
   u00061 : constant Version_32 := 16#b85ff4b6#;
   pragma Export (C, u00061, "ada__strings__utf_encoding__stringsS");
   u00062 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00062, "ada__strings__utf_encoding__wide_stringsB");
   u00063 : constant Version_32 := 16#5678478f#;
   pragma Export (C, u00063, "ada__strings__utf_encoding__wide_stringsS");
   u00064 : constant Version_32 := 16#c2b98963#;
   pragma Export (C, u00064, "ada__strings__utf_encoding__wide_wide_stringsB");
   u00065 : constant Version_32 := 16#d7af3358#;
   pragma Export (C, u00065, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00066 : constant Version_32 := 16#683e3bb7#;
   pragma Export (C, u00066, "ada__tagsB");
   u00067 : constant Version_32 := 16#4ff764f3#;
   pragma Export (C, u00067, "ada__tagsS");
   u00068 : constant Version_32 := 16#3548d972#;
   pragma Export (C, u00068, "system__htableB");
   u00069 : constant Version_32 := 16#f1af03bf#;
   pragma Export (C, u00069, "system__htableS");
   u00070 : constant Version_32 := 16#1f1abe38#;
   pragma Export (C, u00070, "system__string_hashB");
   u00071 : constant Version_32 := 16#56ea83c0#;
   pragma Export (C, u00071, "system__string_hashS");
   u00072 : constant Version_32 := 16#e7d0da5b#;
   pragma Export (C, u00072, "system__val_lluS");
   u00073 : constant Version_32 := 16#238798c9#;
   pragma Export (C, u00073, "system__sparkS");
   u00074 : constant Version_32 := 16#a571a4dc#;
   pragma Export (C, u00074, "system__spark__cut_operationsB");
   u00075 : constant Version_32 := 16#629c0fb7#;
   pragma Export (C, u00075, "system__spark__cut_operationsS");
   u00076 : constant Version_32 := 16#365e21c1#;
   pragma Export (C, u00076, "system__val_utilB");
   u00077 : constant Version_32 := 16#f3b10aca#;
   pragma Export (C, u00077, "system__val_utilS");
   u00078 : constant Version_32 := 16#b98923bf#;
   pragma Export (C, u00078, "system__case_utilB");
   u00079 : constant Version_32 := 16#bf658c01#;
   pragma Export (C, u00079, "system__case_utilS");
   u00080 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00080, "ada__text_ioB");
   u00081 : constant Version_32 := 16#60f53344#;
   pragma Export (C, u00081, "ada__text_ioS");
   u00082 : constant Version_32 := 16#b228eb1e#;
   pragma Export (C, u00082, "ada__streamsB");
   u00083 : constant Version_32 := 16#613fe11c#;
   pragma Export (C, u00083, "ada__streamsS");
   u00084 : constant Version_32 := 16#367911c4#;
   ...
   u00099 : constant Version_32 := 16#656e6b06#;
   ...
   u00102 : constant Version_32 := 16#7694007e#;
   ...
   u00113 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00113, "system__concat_2B");
   u00114 : constant Version_32 := 16#c58d28a3#;
   pragma Export (C, u00114, "system__concat_2S");
   u00115 : constant Version_32 := 16#ebb39bbb#;
   pragma Export (C, u00115, "system__concat_5B");
   u00116 : constant Version_32 := 16#30ef8a8f#;
   pragma Export (C, u00116, "system__concat_5S");
   u00117 : constant Version_32 := 16#6c8dee0d#;
   pragma Export (C, u00117, "test_eitherB");
   u00118 : constant Version_32 := 16#9cd3a69c#;
   pragma Export (C, u00118, "functionalS");
   u00119 : constant Version_32 := 16#922778fb#;
   pragma Export (C, u00119, "functional__eitherB");
   u00120 : constant Version_32 := 16#b40d6d10#;
   pragma Export (C, u00120, "functional__eitherS");
   u00121 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00121, "system__assertionsB");
   u00122 : constant Version_32 := 16#567524cf#;
   pragma Export (C, u00122, "system__assertionsS");
   u00123 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00123, "ada__assertionsB");
   u00124 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00124, "ada__assertionsS");
   u00125 : constant Version_32 := 16#ce5f50f9#;
   pragma Export (C, u00125, "system__val_intS");
   u00126 : constant Version_32 := 16#39f8db91#;
   pragma Export (C, u00126, "system__val_unsS");
   u00127 : constant Version_32 := 16#d4318a80#;
   pragma Export (C, u00127, "test_frameworkB");
   u00128 : constant Version_32 := 16#247bcf50#;
   pragma Export (C, u00128, "test_frameworkS");
   u00129 : constant Version_32 := 16#f0559deb#;
   pragma Export (C, u00129, "test_optionB");
   u00130 : constant Version_32 := 16#a2388006#;
   pragma Export (C, u00130, "functional__optionB");
   u00131 : constant Version_32 := 16#e05d63e0#;
   pragma Export (C, u00131, "functional__optionS");
   u00132 : constant Version_32 := 16#491fa919#;
   pragma Export (C, u00132, "test_resultB");
   u00133 : constant Version_32 := 16#1ec6b861#;
   pragma Export (C, u00133, "functional__resultB");
   u00134 : constant Version_32 := 16#4bfb971e#;
   pragma Export (C, u00134, "functional__resultS");
   u00135 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00135, "system__concat_3B");
   u00136 : constant Version_32 := 16#fa0c42f6#;
   pragma Export (C, u00136, "system__concat_3S");
   u00137 : constant Version_32 := 16#37ee55a8#;
   pragma Export (C, u00137, "test_tryB");
   u00138 : constant Version_32 := 16#c4e7ec8b#;
   pragma Export (C, u00138, "functional__tryB");
   u00139 : constant Version_32 := 16#14a2fbdd#;
   pragma Export (C, u00139, "functional__tryS");
   u00140 : constant Version_32 := 16#0ec9980b#;
   pragma Export (C, u00140, "functional__try__to_resultB");
   u00141 : constant Version_32 := 16#39e504ab#;
   pragma Export (C, u00141, "functional__try__to_resultS");
   u00142 : constant Version_32 := 16#ab240c7c#;
   pragma Export (C, u00142, "test_try_optionB");
   u00143 : constant Version_32 := 16#56855740#;
   pragma Export (C, u00143, "functional__try__to_optionB");
   u00144 : constant Version_32 := 16#489afd0d#;
   pragma Export (C, u00144, "functional__try__to_optionS");
   ...
   --  functional.try%s
   --  functional.try%b
   --  functional.try.to_option%s
   --  functional.try.to_option%b
   --  functional.try.to_result%s
   --  functional.try.to_result%b
   --  test_framework%s
   --  test_framework%b
   --  test_either%b
   --  test_option%b
